...
gingko <- as_tsibble(gingko, index = Year)


gingko |>
  ACF(first_frost_julian_noaa,lag_max = 47) |>
  autoplot()

gingko|>
  gg_tsdisplay(difference(first_frost_julian_noaa), plot_type = "partial")

arima_forecast_frost_plot<-gingko|>
  model(ARIMA(first_frost_julian_noaa)) |>
  forecast(h=5) |>
  autoplot(gingko)

arima_forecast_frost_plot
...
resid_tbl<-augment(arima_fit)

#large p value indicates white noise
resid_tbl|>
...
This model predicts day 311 in 2025
>>>>>>> d512533652d0fe94220984e4885dbdeea3dcd18c
